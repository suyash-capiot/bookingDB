	...
	<form method="post" action="getDetails">
		...
		<div style="background-color: blue; color: white; padding: 10px;">
			<div style="background-color: yellow; color: black; padding: 20px;">
				...
				<input type="radio" name="tripType" id="OneWay" value="OneWay"  >OneWay
				<input type="radio" name="tripType" id="Return" value="Return" checked>Return 
				<input type="radio" name="tripType" id="Multicity" value="Multicity" > Multicity 
				<input type="radio" name="tripType" id="FlightHotel" value="FlightHotel">Flight+Hotel
			</div>
			<p></p>
			<div id='div1'>
