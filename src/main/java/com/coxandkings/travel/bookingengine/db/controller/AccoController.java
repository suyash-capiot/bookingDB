...
import com.coxandkings.travel.bookingengine.db.orchestrator.AccoBookingServiceImpl;
...
public class AccoController {
	...
	public  ResponseEntity<String> updateDetails(InputStream req,  @PathVariable("updateType") String updateType) throws BookingEngineDBException{
		...
		String res =  accoService.updateOrder(reqJson,updateType);
		return new ResponseEntity<String>(res, HttpStatus.OK);	
	}
	
	@GetMapping(value="/getAccoOrders/",produces=MediaType.APPLICATION_JSON_VALUE)
	public  ResponseEntity<String> getAccoOrdersBySuppID(@RequestParam String suppID){
		String res =  accoService.getBysuppID(suppID);
		return new ResponseEntity<String>(res, HttpStatus.OK);	
